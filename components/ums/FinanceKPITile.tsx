  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <div className="mb-1 flex min-w-0 items-center gap-2">
            <p title={label} className="min-w-0 flex-1 truncate text-[11px] font-[700] text-[#5A6B7A] uppercase tracking-wide">
              {label}
            </p>
            {isDerived && (
        ...
        {target && (
          <div className="text-right">
            ...
            <p className="font-['Courier'] text-[14px] font-[600] text-[#5A6B7A]">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[11px] text-[#9AA6B4]">vs prior</span>
      </div>
    </motion.div>
  )
}

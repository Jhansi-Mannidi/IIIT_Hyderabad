...
export function LeaveBrokerHeatmap({ data }: LeaveBrokerHeatmapProps) {
  ...
  const badgeColor = isDark ? '#6E91B8' : VIZ.blue
  const badgeBg = isDark ? 'rgba(110,145,184,0.22)' : 'rgba(37,99,167,0.12)'
              ...
              return (
                <tr key={dept.department} className="border-b border-[#F0F4F7]">
                  ...
                  <td className="text-center p-2">
                    <span
                      className="px-2 py-1 rounded-[4px] text-[9px] font-[700]"
